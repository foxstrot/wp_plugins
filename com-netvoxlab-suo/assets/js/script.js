var printTicket = function(model) {
...
var getTicket = function(){
	...
	suo.innerHTML = '<label>Вы успешно зарегистрированы!</label><br/><br/><input type="button" class="btn" id="eowpSend" onclick="return ticket()" value="Печать талона"/>';
